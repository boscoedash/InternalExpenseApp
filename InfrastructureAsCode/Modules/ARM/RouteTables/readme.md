...
| :-- | :-- | :-- |
| `routeTableName` | string | The name of the Route Table deployed. |
| `routeTableResourceGroup` | string | The name of the Resource Group the Route Table was deployed to. |
| `routeTableResourceId` | string | The Resource id of the Virtual Network deployed. |
